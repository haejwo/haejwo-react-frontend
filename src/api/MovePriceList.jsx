...
export default function MovePriceList({ pk, onClose }) {
    ...
    // console.log(Object.values(match).find(value => value === 'match') !== undefined)
    console.log(lists);
    return (
        <div className='p-4'>
            ...
            <div>
                {lists && lists.map((item, idx) => (
                    <div key={idx} className='flex items-center justify-between border-b-4 border-bottom-zinc-200 pb-3 pt-3'>
                        <div>
